    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-white/70 mb-10 max-w-xl mx-auto">
          Speak with our destination experts and let us craft your perfect
          Indian adventure. No obligation, just inspiration.
        </p>
        ...
        <div className="grid sm:grid-cols-3 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-white/60 text-sm mt-1">+91 7078644407</p>
          </a>

          <a
            href="https://wa.me/917078644407"
            target="_blank"
          ...
          >
            ...
            <p className="text-white/60 text-sm mt-1">Quick Chat</p>
          </a>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            href="https://wa.me/917078644407?text=Hi%2C%20I%27d%20like%20to%20plan%20a%20trip%20to%20India"
            target="_blank"
            rel="noopener noreferrer"
            className="btn-accent text-lg !py-4 !px-10"
          >
            Plan My Trip
            <svg
              className="w-5 h-5"
          ...
          <a href="tel:+917078644407" className="btn-outline text-lg !py-4 !px-10">
            Call Now
          </a>
        </div>
      </div>
